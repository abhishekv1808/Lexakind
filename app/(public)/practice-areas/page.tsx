    ...
    <>
      ...
      <section className="relative overflow-hidden bg-blk px-5 pb-16 pt-[140px] md:px-12 md:pb-20 md:pt-[168px]">
        ...
        <div className="relative mx-auto w-full max-w-6xl">
          ...
          <h1 className="max-w-[640px] font-display text-[28px] font-medium leading-[1.15] tracking-tight text-white md:text-[52px] md:leading-[1.1]">
            All Legal Services
          </h1>
          <p className="mt-5 max-w-[540px] font-body text-[13px] font-normal leading-[1.7] text-[#adadb4] md:text-[16px]">
