...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition-transform duration-200 hover:scale-110"
    >
      <svg
        viewBox="0 0 24 24"
        width="26"
